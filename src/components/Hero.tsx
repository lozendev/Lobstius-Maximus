    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 w-full p-6 z-20 flex justify-between items-center max-w-7xl mx-auto right-0">
        <div className="flex flex-col items-center">
          <img src="/prof2.png" alt="Lobstius" className="h-10 w-10 object-contain" />
          <span className="font-sans text-[8px] uppercase tracking-[0.2em] text-gray-400 opacity-80 mt-1">LOZEN PRJKT</span>
        </div>
        ...
        <button className="bg-gradient-to-r from-red-600 to-orange-500 text-white font-bold py-2 px-6 rounded-full text-sm hover:scale-105 transition-transform shadow-[0_0_15px_rgba(230,57,70,0.5)]">
          View Chart 📊
        </button>
      </nav>
      ...
      <div className="relative z-10 flex flex-col items-center text-center mt-20 px-4 w-full max-w-5xl">
        ...
        >
          <button className="w-full sm:w-auto bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-400 btn-gradient-anim text-black font-bold py-4 px-8 rounded-xl text-sm tracking-wider hover:scale-105 transition-transform flex items-center justify-center space-x-2 shadow-[0_0_20px_rgba(251,191,36,0.3)]">
            <span>🚀</span>
      ...
      <motion.div 
        ...
        className="fixed bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-50 pointer-events-none"
      >
        <span className="text-2xl mb-2 animate-bounce">🦞</span>
        <div className="w-[1px] h-12 bg-gradient-to-b from-lobstius-red to-transparent"></div>
      </motion.div>
    </section>
  );
}
